<template>
  <div id="app">
    ...
    <table class="table table-hover table-dark">
      ...
      <tbody is="transition-group" name="list-empleados" @leave="leave" :css="false">
        <tr v-for="(row, index) in empleados" class="list-empleado" :key="row.id">
          <td>
            <div>{{ row.id }}</div>
          </td>
          <td>
          ...
          <td>
            <div>
              <button
                type="button"
                @click="editar=true;showModal(index,row)"
                class="btn"
